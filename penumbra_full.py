# ============================================================
# PENUMBRA COUNTS + ENERGY + MAGNETIC FLUX ANALYSIS
#
# FULL VERSION
# Based on:
# 1. Umbra code
# 2. Plage full plots code
# 3. Penumbra energy code
#
...
cont_directory = "/home/munjiba/Documents/working/14056/hmi_flux/smoothed_continuum/"
...
patch_cont_files = sorted(
    glob.glob(
        os.path.join(
            cont_directory,
            "*continuum_cutout.fits"
        )
    )
)
...
for suit_patch_file in patch_suit_files:
    ...
    try:
        ...
        cont_patch = fits.getdata(
            cont_patch_file
        ).astype(float)

        cont_patch = np.nan_to_num(
            cont_patch,
            nan=0.0
        )
        ...
        penumbra_mask = (
            (cont_patch >= 0.6 * qs_cont)
            &
            (cont_patch < 0.9 * qs_cont)
        )

        if np.sum(penumbra_mask) == 0:
...
save_plot(
    ...
    total_counts_arr,
    total_counts_err_arr,
    "Total Penumbra Counts (DN)",
    "total_counts_dn_penumbra.png"
)
...
save_plot(
    ...
    mean_counts_arr,
    mean_counts_err_arr,
    "Mean Penumbra Counts (DN)",
    "mean_counts_dn_penumbra.png"
)
...
save_plot(
    ...
    total_energy_arr,
    total_energy_err_arr,
    r"Total Penumbra Energy ($ergs/s/cm^2$)",
    "total_energy_penumbra.png"
)
...
save_plot(
    ...
    mean_energy_arr,
    mean_energy_err_arr,
    r"Mean Penumbra Energy ($ergs/s/cm^2$)",
    "mean_energy_penumbra.png"
)
...
save_plot(
    ...
    total_field_arr,
    total_field_err_arr,
    "Total Penumbra Magnetic Field (G)",
    "total_field_penumbra.png"
)
...
save_plot(
    ...
    mean_field_arr,
    mean_field_err_arr,
    "Mean Penumbra Magnetic Field (G)",
    "mean_field_penumbra.png"
)
...
save_correlation_plot(
    ...
    "Total Counts (DN)",
    "total_counts_vs_total_flux_penumbra.png"
)
...
save_correlation_plot(
    ...
    "Total Counts (DN)",
    "total_counts_vs_total_field_penumbra.png"
)
...
save_correlation_plot(
    ...
    "Mean Counts (DN)",
    "mean_counts_vs_mean_flux_penumbra.png"
)
...
save_correlation_plot(
    ...
    "Mean Counts (DN)",
    "mean_counts_vs_mean_field_penumbra.png"
)
...
save_correlation_plot(
    ...
    "total_energy_vs_total_flux_penumbra.png"
)
...
save_correlation_plot(
    ...
    "Total Magnetic Field (G)",
    r"Total Energy ($ergs/s/cm^2$)",
    "total_energy_vs_total_field_penumbra.png"
)
...
save_correlation_plot(
    ...
    "mean_energy_vs_mean_flux_penumbra.png"
)
...
save_correlation_plot(
    ...
    "Mean Magnetic Field (G)",
    r"Mean Energy ($ergs/s/cm^2$)",
    "mean_energy_vs_mean_field_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    "Total Counts (DN)",
    "Total Unsigned Flux (Mx)",
    "total_counts_total_flux_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    "Total Counts (DN)",
    "Total Magnetic Field (G)",
    "total_counts_total_field_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    "Mean Counts (DN)",
    "Mean Unsigned Flux (Mx)",
    "mean_counts_mean_flux_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    "Mean Counts (DN)",
    "Mean Magnetic Field (G)",
    "mean_counts_mean_field_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Total Energy ($ergs/s/cm^2$)",
    "Total Unsigned Flux (Mx)",
    "total_energy_total_flux_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Total Energy ($ergs/s/cm^2$)",
    "Total Magnetic Field (G)",
    "total_energy_total_field_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Mean Energy ($ergs/s/cm^2$)",
    "Mean Unsigned Flux (Mx)",
    "mean_energy_mean_flux_time_penumbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Mean Energy ($ergs/s/cm^2$)",
    "Mean Magnetic Field (G)",
    "mean_energy_mean_field_time_penumbra.png"
)

print("==========================================")
print("ALL PENUMBRA PLOTS CREATED SUCCESSFULLY")
print("==========================================")