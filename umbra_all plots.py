...
patch_cont_files = sorted(glob.glob(os.path.join(cont_directory, "*continuum_cutout.fits")))
...
for suit_patch_file in patch_suit_files:
    ...
    try:
        ...
        hmi_patch_file = find_closest(time_patch, patch_hmi_files)
        ...
        qs_patch = np.median(suit_patch[mask_patch])
        ...
        cont_patch = fits.getdata(cont_patch_file).astype(float)

        cont_patch = np.nan_to_num(cont_patch, nan=0.0)

        qs_cont = np.median(cont_patch[mask_patch])

        # ====================================================
        # UMBRA MASK
        # ====================================================

        umbra_mask = cont_patch < (0.6 * qs_cont)

        if np.sum(umbra_mask) == 0:
            continue
        ...
        suit_umbra = suit_patch[umbra_mask]

        total_counts_raw = np.sum(suit_umbra)

        N_pixels = suit_umbra.size
        ...
        correction_factor = qs_center / qs_patch
...
save_plot(
    ...
    total_counts_arr,
    total_counts_err_arr,
    "Total Umbra Counts (DN)",
    "total_counts_dn_umbra.png"
)
...
save_plot(
    ...
    mean_counts_arr,
    mean_counts_err_arr,
    "Mean Umbra Counts (DN)",
    "mean_counts_dn_umbra.png"
)
...
save_plot(
    ...
    total_energy_arr,
    total_energy_err_arr,
    r"Total Umbra Energy ($ergs/s/cm^2$)",
    "total_energy_umbra.png"
)
...
save_plot(
    ...
    mean_energy_arr,
    mean_energy_err_arr,
    r"Mean Umbra Energy ($ergs/s/cm^2$)",
    "mean_energy_umbra.png"
)
...
save_correlation_plot(
    ...
    "Total Counts (DN)",
    "total_counts_vs_total_flux_umbra.png"
)
...
save_correlation_plot(
    ...
    "Total Counts (DN)",
    "total_counts_vs_total_field_umbra.png"
)
...
save_correlation_plot(
    ...
    "Mean Counts (DN)",
    "mean_counts_vs_mean_flux_umbra.png"
)
...
save_correlation_plot(
    ...
    "Mean Counts (DN)",
    "mean_counts_vs_mean_field_umbra.png"
)

# ------------------------------------------------------------
# ENERGY vs FLUX/FIELD
# ------------------------------------------------------------
...
save_correlation_plot(
    ...
    "total_energy_vs_total_flux_umbra.png"
)
...
save_correlation_plot(
    ...
    "Total Magnetic Field (G)",
    r"Total Energy ($ergs/s/cm^2$)",
    "total_energy_vs_total_field_umbra.png"
)
...
save_correlation_plot(
    ...
    "mean_energy_vs_mean_flux_umbra.png"
)
...
save_correlation_plot(
    ...
    "Mean Magnetic Field (G)",
    r"Mean Energy ($ergs/s/cm^2$)",
    "mean_energy_vs_mean_field_umbra.png"
)
...
save_dual_axis_plot(
    ...
    "Total Counts (DN)",
    "Total Unsigned Flux (Mx)",
    "total_counts_total_flux_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    "Total Counts (DN)",
    "Total Magnetic Field (G)",
    "total_counts_total_field_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    "Mean Counts (DN)",
    "Mean Unsigned Flux (Mx)",
    "mean_counts_mean_flux_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    "Mean Counts (DN)",
    "Mean Magnetic Field (G)",
    "mean_counts_mean_field_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Total Energy ($ergs/s/cm^2$)",
    "Total Unsigned Flux (Mx)",
    "total_energy_total_flux_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Total Energy ($ergs/s/cm^2$)",
    "Total Magnetic Field (G)",
    "total_energy_total_field_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Mean Energy ($ergs/s/cm^2$)",
    "Mean Unsigned Flux (Mx)",
    "mean_energy_mean_flux_time_umbra.png"
)
...
save_dual_axis_plot(
    ...
    r"Mean Energy ($ergs/s/cm^2$)",
    "Mean Magnetic Field (G)",
    "mean_energy_mean_field_time_umbra.png"
)

print("==========================================")
print("ALL 24 PLOTS CREATED SUCCESSFULLY")
print("==========================================")